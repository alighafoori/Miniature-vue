...
const locale = {
  ...
  'tableedit.Rule number': 'Rule number',
  'tableedit.status of use': 'status of use',
  'tableedit.please choose': 'please choose',
  'tableedit.All': 'All',
  'tableedit.shut down': 'shut down',
  'tableedit.Running': 'Running',
  'tableedit.Calls': 'Calls',
  'tableedit.Updated': 'Updated',
  'tableedit.update date': 'Please enter the update date',
  'tableedit.Inquire': 'Inquire',
  'tableedit.Reset': 'Reset',
  'tableedit.Collapse': 'Collapse',
  'tableedit.Unfold': 'Unfold',
  'tableedit.New': 'New',
  'tableedit.delete': 'delete',
  'tableedit.locking': 'locking',
  'tableedit.Bulk operations': 'Bulk operations',
  'tableedit.save': 'save',
  'tableedit.give up': 'Do you really give up editing??',
  'tableedit.cancel': 'cancel',
  'tableedit.modify': 'modify',
  'tableedit.description': 'description',
  'tableedit.Service calls': 'Service calls',
  'tableedit.Times': 'Times',
  'tableedit.status': 'status',
  'tableedit.Update time': 'Update time',
  'tableedit.operating': 'operating',
  'tableedit.delconfirm.title': 'Warning',
  'tableedit.delconfirm.ok': 'Delete',
  'tableedit.delconfirm.cancel': 'Cancel',
  'tableedit.delconfirm.content1': 'Really delete',
  'tableedit.delconfirm.content2': 'Is it?',
  'userlist.Role ID': 'Role ID',
  'userlist.please enter': 'please enter',
  'userlist.status': 'status',
  'userlist.please choose': 'please choose',
  'userlist.All': 'All',
  'userlist.shut down': 'shut down',
  'userlist.Running': 'Running',
  'userlist.Inquire': 'Inquire',
  'userlist.Reset': 'Reset',
  'userlist.edit': 'edit',
  'userlist.More ': 'More ',
  'userlist.Details': 'Details',
  'userlist.Disable': 'Disable',
  'userlist.delete': 'delete',
  'userlist.operating': 'operating',
  'userlist.Unique identifier': 'Unique identifier',
  'userlist.Role Name': 'Role Name',
  'userlist.Give a name': 'Give a name',
  'userlist.normal': 'normal',
  'userlist.description': 'description',
  'userlist.Have permissions': 'Have permissions',
  'userlist.select all': 'select all',
  'userlist.columns.Unique identifier': 'Unique identifier',
  'userlist.columns.Role Name': 'Role Name',
  'userlist.columns.status': 'status',
  'userlist.columns.Creation time': 'Creation time',
  'userlist.columns.operating': 'operating',
  'userlist.status.Enable': 'Enable',
  'userlist.status.Disable': 'Disable',
  'userlist.desciption': 'List usage scenarios: Permission management and role management in background management can be used for role permission control based on RBAC design, granularity down to each operation type.',
  'permission.Add': 'Add',
  'permission.delete': 'delete',
  'permission.modify': 'modify',
  'permission.Inquire': 'Inquire',
  ...
  'permissionlist.Role ID': 'Role ID',
  'permissionlist.please enter': 'please enter',
  'permissionlist.status': 'status',
  'permissionlist.please choose': 'please choose',
  'permissionlist.All': 'All',
  'permissionlist.shut down': 'shut down',
  'permissionlist.Running': 'Running',
  'permissionlist.Inquire': 'Inquire',
  'permissionlist.Reset': 'Reset',
  'permissionlist.edit': 'edit',
  'permissionlist.More ': 'More ',
  'permissionlist.Details': 'Details',
  'permissionlist.Disable': 'Disable',
  'permissionlist.delete': 'delete',
  'permissionlist.operating': 'operating',
  'permissionlist.Unique identifier': 'Unique identifier',
  'permissionlist.Permission name': 'Permission name',
  'permissionlist.Give a name': 'Give a name',
  'permissionlist.normal': 'normal',
  'permissionlist.description': 'description',
  'permissionlist.Give permissions': 'Give permissions',
  'permissionlist.columns.Unique identifier': 'Unique identifier',
  'permissionlist.columns.Permission name': 'Permission name',
  'permissionlist.columns.Operable authority': 'Operable authority',
  'permissionlist.columns.status': 'status',
  'permissionlist.columns.operating': 'operating',
  'permissionlist.description.content': 'List usage scenarios: Permission management and role management in background management can be used for role permission control based on RBAC design, granularity down to each operation type.',
  'permissionlist.data.Add': 'Add',
  'permissionlist.data.Inquire': 'Inquire',
  'permissionlist.data.modify': 'modify',
  'permissionlist.data.List': 'List',
  'permissionlist.data.delete': 'delete',
  'permissionlist.data.Import': 'Import',
  'permissionlist.data.Export': 'Export',
  'permissionlist.statusmap.normal': 'normal',
  'permissionlist.statusmap.Disable': 'Disable',
  ...
  'Login.Account password login': 'Account password login',
  'Login.IncorrectAccount': 'Incorrect account or password (admin/ant.design)',
  'Login.AccountAdmin': 'Account: admin: admin',
  'Login.EnterEmail': 'Please enter account name or email address',
  'Login.Password': 'Password: admin or ant.design: admin or ant.design',
  'Login.PleaseEnterPassword': 'Please enter password',
  'Login.MobilePhone': 'Mobile phone number login',
  'Login.phoneNumber': 'phone number',
  'Login.validPhoneNumber': 'please enter a valid phone number',
  'Login.VerificationCode': 'Verification code',
  'Login.EnterVerificationCode': 'please enter verification code',
  'Login.getverificationCode': 'get verification code',
  'Login.autoLogin': 'auto login',
  'Login.forgetPassword': 'forget password',
  'Login.determine': 'determine',
  'Login.OtherLoginMethods': 'Other login methods',
  'Login.registerAccount': 'register account',
  'Login.js.verification code': 'The verification code is being sent..',
  'Login.js.prompt': 'prompt',
  'Login.js.your verification': 'The verification code is obtained successfully, your verification code is:',
  'Login.js.welcome': 'welcome',
  'Login.js.Welcome back': 'Welcome back',
  'Login.js.error': 'error',
  'Login.js.error message': 'There was an error in the request, please try again later',
  'TwoStepCaptcha.Two-step verification': 'Two-step verification',
  'TwoStepCaptcha.return': 'return',
  'TwoStepCaptcha.carry on': 'carry on',
  'TwoStepCaptcha.Google Authenticator': 'Please open Google Authenticator or two-step verification app on your phone',
  'TwoStepCaptcha.dynamic code': 'Enter 6-digit dynamic code',
  'TwoStepCaptcha.Verifying': 'Verifying...',
  'TwoStepCaptcha.please wait': 'please wait',
  'TwoStepCaptcha.dynamic code!': 'Please enter 6-digit dynamic code!',
  'TwoStepCaptcha.Lost your phone?': 'Lost your phone?',
  'Register.registered': 'registered',
  'Register.mailbox': 'mailbox',
  'Register.email address': 'Please input the email address',
  'Register.strength:': 'strength:',
  'Register.password message': 'Please enter at least 6 characters. Please do not use passwords that are easy to guess.',
  'Register.password error': 'At least 6-digit password, case sensitive',
  'Register.confirm password': 'confirm password',
  'Register.Phone number': 'Phone number',
  'Register.valid phone number': 'please enter a valid phone number',
  'Register.Verification code': 'Verification code',
  'Register.verification code': 'please enter verification code',
  'Register.get verification code': 'get verification code',
  'Register.existing account': 'Log in with an existing account',
  'Register.js.low': 'low',
  'Register.js.in': 'in',
  'Register.js.Strong': 'Strong',
  'Register.js.password enough': 'The password is not strong enough',
  'Register.js.Please enter password': 'Please enter password',
  'Register.js.two passwords': 'The two passwords are inconsistent',
  'Register.js.verification code sent': 'The verification code is being sent..',
  'Register.js.prompt': 'prompt',
  'Register.js.your verification code': 'The verification code is obtained successfully, your verification code is:',
  'Register.js.error': 'error',
  'Register.js.try again later': 'There was an error in the request, please try again later',
  'RegisterResult.View mailbox': 'View mailbox',
  'RegisterResult.Back to top': 'Back to top',
  'RegisterResult.js.description': 'The activation email has been sent to your mailbox, and the email is valid for 24 hours. Please log in to your mailbox in time and click the link in the email to activate your account.',
  'RegisterResult.js.your account': 'your account',
  'RegisterResult.js.successfully registered': 'successfully registered'
}
