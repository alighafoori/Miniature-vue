...
const locale = {
  ...
  'tableedit.Rule number': 'شماره قانون',
  'tableedit.status of use': 'وضعیت استفاده',
  'tableedit.please choose': 'لطفا انتخاب کنید',
  'tableedit.All': 'همه',
  'tableedit.shut down': 'خاموش',
  'tableedit.Running': 'در حال دویدن',
  'tableedit.Calls': 'تماس می گیرد',
  'tableedit.Updated': 'به روز شده',
  'tableedit.update date': 'لطفا تاریخ بروزرسانی را وارد کنید',
  'tableedit.Inquire': 'جویا شدن',
  'tableedit.Reset': 'تنظیم مجدد',
  'tableedit.Collapse': 'سقوط - فروپاشی',
  'tableedit.Unfold': 'آشکار شد',
  'tableedit.New': 'جدید',
  'tableedit.delete': 'حذف',
  'tableedit.locking': 'قفل کردن',
  'tableedit.Bulk operations': 'عملیات فله',
  'tableedit.save': 'صرفه جویی',
  'tableedit.give up': 'آیا واقعاً از ویرایش خودداری می کنید؟?',
  'tableedit.cancel': 'لغو',
  'tableedit.modify': 'تغییر',
  'tableedit.description': 'شرح',
  'tableedit.Service calls': 'خدمات تماس',
  'tableedit.Times': 'بار',
  'tableedit.status': 'وضعیت',
  'tableedit.Update time': 'زمان بروزرسانی کنید',
  'tableedit.operating': 'عملیاتی',
  'tableedit.delconfirm.title': 'هشدار',
  'tableedit.delconfirm.ok': 'حذف',
  'tableedit.delconfirm.cancel': 'انصراف',
  'tableedit.delconfirm.content1': 'واقعا می خواهید حذف',
  'tableedit.delconfirm.content2': 'کنید؟',
  'userlist.Role ID': 'شناسه نقش',
  'userlist.please enter': 'لطفا وارد کنید',
  'userlist.status': 'وضعیت',
  'userlist.please choose': 'لطفا انتخاب کنید',
  'userlist.All': 'همه',
  'userlist.shut down': 'خاموش',
  'userlist.Running': 'در حال دویدن',
  'userlist.Inquire': 'جویا شدن',
  'userlist.Reset': 'تنظیم مجدد',
  'userlist.edit': 'ویرایش کنید',
  'userlist.More ': 'بیشتر ',
  'userlist.Details': 'جزئیات',
  'userlist.Disable': 'غیرفعال کردن',
  'userlist.delete': 'حذف',
  'userlist.operating': 'عملیاتی',
  'userlist.Unique identifier': 'شناسه منحصر به فرد',
  'userlist.Role Name': 'نام نقش',
  'userlist.Give a name': 'یک اسم بزن',
  'userlist.normal': 'طبیعی',
  'userlist.description': 'شرح',
  'userlist.Have permissions': 'مجوز داشته باشید',
  'userlist.select all': 'انتخاب همه',
  'userlist.columns.Unique identifier': 'شناسه منحصر به فرد',
  'userlist.columns.Role Name': 'نام نقش',
  'userlist.columns.status': 'وضعیت',
  'userlist.columns.Creation time': 'زمان ایجاد',
  'userlist.columns.operating': 'عملیاتی',
  'userlist.status.Enable': 'فعال کردن',
  'userlist.status.Disable': 'غیرفعال کردن',
  'userlist.desciption': 'سناریوهای استفاده از لیست: مدیریت مجوز و مدیریت نقش در مدیریت پس زمینه می تواند برای کنترل اجازه نقش بر اساس طرح RBAC ، میزان انبوه به هر نوع عملیات مورد استفاده قرار گیرد.',
  'permission.Add': 'اضافه کردن',
  'permission.delete': 'حذف',
  'permission.modify': 'تغییر',
  'permission.Inquire': 'جویا شدن',
  'permission.Details': 'جزئیات',
  ...
  'permissionlist.Role ID': 'شناسه نقش',
  'permissionlist.please enter': 'لطفا وارد کنید',
  'permissionlist.status': 'وضعیت',
  'permissionlist.please choose': 'لطفا انتخاب کنید',
  'permissionlist.All': 'همه',
  'permissionlist.shut down': 'خاموش',
  'permissionlist.Running': 'در حال دویدن',
  'permissionlist.Inquire': 'جویا شدن',
  'permissionlist.Reset': 'تنظیم مجدد',
  'permissionlist.edit': 'ویرایش کنید',
  'permissionlist.More ': 'بیشتر ',
  'permissionlist.Details': 'جزئیات',
  'permissionlist.Disable': 'غیرفعال کردن',
  'permissionlist.delete': 'حذف',
  'permissionlist.operating': 'عملیاتی',
  'permissionlist.Unique identifier': 'شناسه منحصر به فرد',
  'permissionlist.Permission name': 'نام مجوز',
  'permissionlist.Give a name': 'یک اسم بزن',
  'permissionlist.normal': 'طبیعی',
  'permissionlist.description': 'شرح',
  'permissionlist.Give permissions': 'مجوز بدهید',
  'permissionlist.columns.Unique identifier': 'شناسه منحصر به فرد',
  'permissionlist.columns.Permission name': 'نام مجوز',
  'permissionlist.columns.Operable authority': 'اقتدار عملیاتی',
  'permissionlist.columns.status': 'وضعیت',
  'permissionlist.columns.operating': 'عملیاتی',
  'permissionlist.description.content': 'سناریوهای استفاده از لیست: مدیریت مجوز و مدیریت نقش در مدیریت پس زمینه می تواند برای کنترل اجازه نقش بر اساس طرح RBAC ، میزان انبوه به هر نوع عملیات مورد استفاده قرار گیرد.',
  'permissionlist.data.Add': 'اضافه کردن',
  'permissionlist.data.Inquire': 'جویا شدن',
  'permissionlist.data.modify': 'تغییر',
  'permissionlist.data.List': 'لیست',
  'permissionlist.data.delete': 'حذف',
  ...
  'Login.Account password login': 'ورود به سیستم رمز عبور حساب',
  'Login.IncorrectAccount': 'حساب یا گذرواژه نادرست (سرپرست / ant.design)',
  'Login.AccountAdmin': 'حساب: مدیر: admin',
  'Login.EnterEmail': 'لطفاً نام حساب یا آدرس ایمیل خود را وارد کنید',
  'Login.Password': 'رمز عبور: مدیر یا ant.design: admin or ant.design',
  'Login.PleaseEnterPassword': 'لطفا رمز عبور را وارد کنید',
  'Login.MobilePhone': 'ورود به شماره تلفن همراه',
  'Login.phoneNumber': 'شماره تلفن',
  'Login.validPhoneNumber': 'لطفا یک شماره تلفن معتبر وارد کنید',
  'Login.VerificationCode': 'کد تایید',
  'Login.EnterVerificationCode': 'لطفا کد تأیید را وارد کنید',
  'Login.getverificationCode': 'کد تأیید را دریافت کنید',
  'Login.autoLogin': 'ورود خودکار',
  'Login.forgetPassword': 'فراموشی رمز عبور',
  'Login.determine': 'تعیین کردن',
  'Login.OtherLoginMethods': 'سایر روش های ورود به سیستم',
  'Login.registerAccount': 'ثبت نام حساب',
  'Login.js.verification code': 'کد تأیید ارسال می شود ..',
  'Login.js.prompt': 'سریع',
  'Login.js.your verification': 'کد تأیید با موفقیت به دست آمد ، کد تأیید صحت شما این است:',
  'Login.js.welcome': 'خوش آمدی',
  'Login.js.Welcome back': 'خوش آمدید',
  'Login.js.error': 'خطا',
  'Login.js.error message': 'خطایی در درخواست وجود دارد ، لطفاً بعداً دوباره امتحان کنید',
  'TwoStepCaptcha.Two-step verification': 'تأیید دو مرحله ای',
  'TwoStepCaptcha.return': 'برگشت',
  'TwoStepCaptcha.carry on': 'ادامه دادن',
  'TwoStepCaptcha.Google Authenticator': 'لطفاً Google Authenticator یا برنامه تأیید صحت دو مرحله ای روی تلفن خود باز کنید',
  'TwoStepCaptcha.dynamic code': 'کد پویا 6 رقمی را وارد کنید',
  'TwoStepCaptcha.Verifying': 'در حال تأیید ...',
  'TwoStepCaptcha.please wait': 'لطفا صبر کنید',
  'TwoStepCaptcha.dynamic code!': 'لطفا کد پویا 6 رقمی را وارد کنید!',
  'TwoStepCaptcha.Lost your phone?': 'تلفن خود را گم کردی؟',
  'Register.registered': 'ثبت شده',
  'Register.mailbox': 'صندوق پستی',
  'Register.email address': 'لطفا آدرس ایمیل را وارد کنید',
  'Register.strength:': 'استحکام - قدرت:',
  'Register.password message': 'لطفا حداقل 6 کاراکتر را وارد کنید. لطفاً از رمزهای عبور استفاده نکنید که به راحتی حدس بزنید.',
  'Register.password error': 'حداقل رمز عبور 6 رقمی ، حساس به مورد',
  'Register.confirm password': 'رمز عبور را تأیید کنید',
  'Register.Phone number': 'شماره تلفن',
  'Register.valid phone number': 'لطفا یک شماره تلفن معتبر وارد کنید',
  'Register.Verification code': 'کد تایید',
  'Register.verification code': 'لطفا کد تأیید را وارد کنید',
  'Register.get verification code': 'کد تأیید را دریافت کنید',
  'Register.existing account': 'با یک حساب کاربری موجود وارد شوید',
  'Register.js.low': 'کم',
  'Register.js.in': 'که در',
  'Register.js.Strong': 'قوی',
  'Register.js.password enough': 'رمز عبور به اندازه کافی قوی نیست',
  'Register.js.Please enter password': 'لطفا رمز عبور را وارد کنید',
  'Register.js.two passwords': 'این دو رمز عبور متناقض هستند',
  'Register.js.verification code sent': 'کد تأیید ارسال می شود ..',
  'Register.js.prompt': 'سریع',
  'Register.js.your verification code': 'کد تأیید با موفقیت به دست آمد. کد تأیید صحت شما این است:',
  'Register.js.error': 'خطا',
  'Register.js.try again later': 'خطایی در درخواست وجود دارد ، لطفاً بعداً دوباره امتحان کنید',
  'RegisterResult.View mailbox': 'صندوق پستی را مشاهده کنید',
  'RegisterResult.Back to top': 'بازگشت به صفحه اصلی',
  'RegisterResult.js.description': 'ایمیل فعال سازی به صندوق پستی شما ارسال شده است ، و نامه الکترونیکی به مدت 24 ساعت معتبر است. لطفاً به موقع وارد صندوق پستی خود شوید و برای فعال کردن حساب خود روی پیوند موجود در ایمیل کلیک کنید.',
  'RegisterResult.js.your account': 'حساب شما',
  'RegisterResult.js.successfully registered': 'با موفقیت ایجاد شد'
}
