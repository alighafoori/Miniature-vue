...
const locale = {
  ...
  'permissionlist.Role ID': '角色ID',
  'permissionlist.please enter': '请输入',
  'permissionlist.status': '状态',
  'permissionlist.please choose': '请选择',
  'permissionlist.All': '全部',
  'permissionlist.shut down': '关闭',
  'permissionlist.Running': '运行中',
  'permissionlist.Inquire': '查询',
  'permissionlist.Reset': '重置',
  'permissionlist.edit': '编辑',
  'permissionlist.More ': '更多 ',
  'permissionlist.Details': '详情',
  'permissionlist.Disable': '禁用',
  'permissionlist.delete': '删除',
  'permissionlist.operating': '操作',
  'permissionlist.Unique identifier': '唯一识别码',
  'permissionlist.Permission name': '权限名称',
  'permissionlist.Give a name': '起一个名字',
  'permissionlist.normal': '正常',
  'permissionlist.description': '描述',
  'permissionlist.Give permissions': '赋予权限',
  'permissionlist.columns.Unique identifier': '唯一识别码',
  'permissionlist.columns.Permission name': '权限名称',
  'permissionlist.columns.Operable authority': '可操作权限',
  'permissionlist.columns.status': '状态',
  'permissionlist.columns.operating': '操作',
  'permissionlist.description.content': '列表使用场景：后台管理中的权限管理以及角色管理，可用于基于 RBAC 设计的角色权限控制，颗粒度细到每一个操作类型。',
  'permissionlist.data.Add': '新增',
  'permissionlist.data.Inquire': '查询',
  'permissionlist.data.modify': '修改',
  'permissionlist.data.List': '列表',
  'permissionlist.data.delete': '删除',
  ...
  'Login.Account password login': '账号密码登录',
  'Login.IncorrectAccount': '账户或密码错误（admin/ant.design )',
  'Login.AccountAdmin': '账户: admin',
  'Login.EnterEmail': '请输入帐户名或邮箱地址',
  'Login.Password': '密码: admin or ant.design',
  'Login.PleaseEnterPassword': '请输入密码',
  'Login.MobilePhone': '手机号登录',
  'Login.phoneNumber': '手机号',
  'Login.validPhoneNumber': '请输入正确的手机号',
  'Login.VerificationCode': '验证码',
  'Login.EnterVerificationCode': '请输入验证码',
  'Login.getverificationCode': '获取验证码',
  'Login.autoLogin': '自动登录',
  'Login.forgetPassword': '忘记密码',
  'Login.determine': '确定',
  'Login.OtherLoginMethods': '其他登录方式',
  'Login.registerAccount': '注册账户',
  'Login.js.verification code': '验证码发送中..',
  'Login.js.prompt': '提示',
  'Login.js.your verification': '验证码获取成功，您的验证码为：',
  'Login.js.welcome': '欢迎',
  'Login.js.Welcome back': '欢迎回来',
  'Login.js.error': '错误',
  'Login.js.error message': '请求出现错误，请稍后再试',
  'TwoStepCaptcha.Two-step verification': '两步验证',
  'TwoStepCaptcha.return': '返回',
  'TwoStepCaptcha.carry on': '继续',
  'TwoStepCaptcha.Google Authenticator': '请在手机中打开 Google Authenticator 或两步验证 APP',
  'TwoStepCaptcha.dynamic code': '输入 6 位动态码',
  'TwoStepCaptcha.Verifying': '正在验证..',
  'TwoStepCaptcha.please wait': '请稍后',
  'TwoStepCaptcha.dynamic code!': '请输入 6 位动态码!',
  'TwoStepCaptcha.Lost your phone?': '遗失手机?',
  'Register.registered': '注册',
  'Register.mailbox': '邮箱',
  'Register.email address': '请输入邮箱地址',
  'Register.strength:': '强度：',
  'Register.password message': '请至少输入 6 个字符。请不要使用容易被猜到的密码。',
  'Register.password error': '至少6位密码，区分大小写',
  'Register.confirm password': '确认密码',
  'Register.Phone number': '位手机号',
  'Register.valid phone number': '请输入正确的手机号',
  'Register.Verification code': '验证码',
  'Register.verification code': '请输入验证码',
  'Register.get verification code': '获取验证码',
  'Register.existing account': '使用已有账户登录',
  'Register.js.low': '低',
  'Register.js.in': '中',
  'Register.js.Strong': '强',
  'Register.js.password enough': '密码强度不够',
  'Register.js.Please enter password': '请输入密码',
  'Register.js.two passwords': '两次密码不一致',
  'Register.js.verification code sent': '验证码发送中..',
  'Register.js.prompt': '提示',
  'Register.js.your verification code': '验证码获取成功，您的验证码为：',
  'Register.js.error': '错误',
  'Register.js.try again later': '请求出现错误，请稍后再试',
  'RegisterResult.View mailbox': '查看邮箱',
  'RegisterResult.Back to top': '返回首页',
  'RegisterResult.js.description': '激活邮件已发送到你的邮箱中，邮件有效期为24小时。请及时登录邮箱，点击邮件中的链接激活帐户。',
  'RegisterResult.js.your account': '你的账户',
  'RegisterResult.js.successfully registered': '注册成功'
}
