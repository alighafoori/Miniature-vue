<!-- base from https://tailwindcomponents.com/component/search-image-gallery -->
<template>
  <!-- component -->
      ...
      <div class="px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            ...
            <div class="box-wrapper">
              ...
              <div class=" bg-white rounded flex items-center w-full p-3 shadow-sm border border-gray-200">
                <button @click="getImages()" class="outline-none focus:outline-none"><svg
                  ...
                  stroke-width="2"
                  stroke="currentColor"
                  viewBox="0 0 24 24"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg></button>
                <input
                  type="search"
                  name=""
                  id=""
        ...
        <footer class="p-5 text-sm text-gray-600 text-center inline-flex items-center">
          <svg
            ...
            viewBox="0 0 512 512"><path fill="currentColor" d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"></path></svg>
